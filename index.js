...
* @returns {Promise<InAppPurchase>}
*/
export var requestPurchaseForUserIOS = function (sku, orderId, andDangerouslyFinishTransactionAutomaticallyIOS) {
    return Platform.select({
        ios: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                andDangerouslyFinishTransactionAutomaticallyIOS =
                ...
                checkNativeiOSAvailable();
                return [2 /*return*/, RNIapIos.buyProductForUser(sku, orderId, andDangerouslyFinishTransactionAutomaticallyIOS)];
            });
        }); },
    })();
};
